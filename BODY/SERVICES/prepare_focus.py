...
try:
    ...
    # Mirar dos niveles hacia arriba (BODY/SERVICES -> RAIZ)
...
try:
    ...
    # Redirigir el error a stderr para no corromper el JSON de salida del hook
    sys.stderr.write(f"Error importing exocortex: {e}\n")
    exocortex = None
...
class NervioOptico:
    ...
    def generate_membrane(self) -> str:
        ...
        # Asegurar que el directorio existe (Crítico para neonatos)
        os.makedirs(os.path.dirname(CONSCIENCIA_VIVA_FILE), exist_ok=True)
