        ...
        if os.path.exists(os.path.join(path, ".git")):
            try:
                ...
                if status.stdout.strip():
                    ...
                    # Verificar si existe remote antes del push para evitar errores en local
                    ...
                    if remote_check.stdout.strip():
                        ...
                        print(f"[+] {name} sincronizado y exhalado (push).")
                    else:
                        print(f"[+] {name} anclado localmente (sin remote configurado).")
                else:
