...
*   [**ARCHITECTURE.md**](./ARCHITECTURE.md): System layers, data flow, and the Triple Alliance.
*   [**INSTALLATION_GUIDE.md**](./INSTALLATION_GUIDE.md): Step-by-step setup (Local, Cloud, Secrets).
...
## 🦾 III. Body (Action Layer)
*The tools and persistent services.*

*   **[BODY/SKILLS/](./BODY/SKILLS/)**: Modular capabilities (Snake_case formalized).
    *   `agenda_management`, `knowledge_management`, `terroir_hygiene`, etc.
*   **[BODY/SERVICES/](./BODY/SERVICES/)**: Always-on components.
...
## 🩺 IV. Senses (Perception & Metabolism)
*The mechanisms of continuity and resonance.*

*   **[SENSES/prepare_focus.py](./SENSES/prepare_focus.py)**: The **Nervio Óptico**. Context pre-processor.
*   **[SENSES/ingest.py](./SENSES/ingest.py)**: The **Metabolism**. Vector DB synchronization.
*   **[SENSES/HOOKS/](./SENSES/HOOKS/)**: Reflexes triggered by environment events.

---

## 🛡️ V. Phenotype (Private History)
